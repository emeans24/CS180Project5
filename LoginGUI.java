 ...
 * Project 5
 *
 * @author Simon Twiss, Saul Means, Timothy Porterfield, Ashutosh Annapantula
 * @version 11/28/2020
 *
 */
...
public class LoginGUI extends JComponent implements Runnable { // it is assumed users will activate Server class (such
    ...
    //this changes depending on the machine, switch this to where ever you want files to be saved
    final String chatFilesPath = "C:\\Users\\ashut\\";
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                if (e.getSource() == enter1) {
                    if (validInfo(userName1.getText(), email.getText(), phoneNumber.getText(),
                            password1.getText()) == true) {
                        ...
                        JOptionPane.showMessageDialog(null, "You're account has been succesfully created!", "Success",
                ...
                if (e.getSource() == enter2) {
                    if (deleteUser(userName2.getText(), password2.getText()) == true) {
                        ...
                        JOptionPane.showMessageDialog(null, "Account Deletion Succesful!", "Success",
                                JOptionPane.PLAIN_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(null, "The username or password you entered is incorrect.",
                                "Error", JOptionPane.ERROR_MESSAGE);
    ...
    public static boolean validInfo(String userName, String email, String phoneNumber, String password) {
        try {
            ...
            if (password.length() < 8) {
                JOptionPane.showMessageDialog(null, "Invalid Password. Must be at least 8 characters", "Error",
            ...
            try {
                ...
                returnStatement = false;
                JOptionPane.showMessageDialog(null, "Invalid Phone Number (Must be 10 digits with numbers only)",
                        "Error", JOptionPane.ERROR_MESSAGE);
            }
            ...
            // similar to indexOf() returning -1 when a character can not be found in a
            // String
        }
    }


    public void ChatStore() {
        Path path = Paths.get(chatFilesPath + userName.getText().trim() + "_CHAT.txt");
        try {
