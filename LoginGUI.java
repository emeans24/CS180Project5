...
public class LoginGUI extends JComponent implements Runnable { // it is assumed users will activate Server class (such
	...
	public void run() {
		try {
			...
			userNameLabel1.setBounds(154, 600, 98, 25);
			...
			passwordLabel1.setBounds(154, 630, 98, 25);
			...
			password1.setBounds(255, 630, 80, 25);
			subLabel1.add(password1);
			JLabel phoneNumberLabel = new JLabel("Phone Number:");
			phoneNumberLabel.setBounds(154, 660, 98, 25);
			...
			JLabel subLabel2 = new JLabel(new ImageIcon("Welcome.png"));
			deleteAccountPanel.add(subLabel2);
			JLabel userNameLabel2 = new JLabel("Username:");
			userNameLabel2.setBounds(154, 600, 80, 25);
			...
			userName2.setBounds(255, 600, 80, 25);
			subLabel2.add(userName2);
			JLabel passwordLabel2 = new JLabel("Password:"); // it is assumed users will only type their
			passwordLabel2.setBounds(154, 630, 80, 25); // passwords (rather than, for example,
